...
import { X, Eye, ArrowUpRight, ChevronDown, Home, ChevronRight } from 'lucide-react';
...
const GalleryPage = () => {
  ...
  const galleryData = [
    { id: 1, src: '/dhanLakshmi-img/11.jpg', title: '24/7 Service', desc: 'Ready for any emergency.' },
    { id: 2, src: '/dhanLakshmi-img/12.jpg', title: '24/7 Service', desc: 'Experts in critical care.' },
    { id: 3, src: '/dhanLakshmi-img/13.jpg', title: '24/7 Service', desc: 'Speed when you need it.' },
    { id: 4, src: '/dhanLakshmi-img/14.jpg', title: '24/7 Service', desc: 'Advanced ICU interiors.' },
    { id: 5, src: '/dhanLakshmi-img/15.jpg', title: '24/7 Service', desc: 'Always available for you.' },
    { id: 6, src: '/dhanLakshmi-img/16.jpg', title: '24/7 Service', desc: 'Serving the community.' },
  ];
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20 lg:pb-24 pt-8 sm:pt-12 lg:pt-16">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-4 sm:p-6 lg:p-8">
                ...
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-100">
                  <h3 className="text-white text-lg sm:text-xl font-bold font-serif mb-1">{item.title}</h3>
                  <p className="text-slate-200 text-xs sm:text-sm mb-3 sm:mb-4">{item.desc}</p>
        ...
        {galleryData.length === 0 && (
          <div className="text-center py-16 sm:py-20 lg:py-24">
            <p className="text-slate-500 text-base sm:text-lg">No images available at the moment.</p>
          </div>
        )}
      </div>
        ...
        >
          ...
          >
            ...
            <div className="mt-4 sm:mt-5 md:mt-6 text-center space-y-1 sm:space-y-2 px-4">
              <h2 className="text-white text-lg sm:text-xl md:text-2xl font-bold">{selectedImage.title}</h2>
              <p className="text-slate-300 sm:text-slate-400 text-sm sm:text-base">{selectedImage.desc}</p>
            </div>
