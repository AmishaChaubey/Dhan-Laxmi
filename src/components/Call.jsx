...
const CallIcon = () => {
  const handleCallClick = () => {
    const phoneNumber = '919711875038';
    ...
    <div className="fixed bottom-6 left-6 z-50">
      <div className="relative group">
        <button
          ...
          className="w-14 h-14 bg-red-800  rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 ease-in-out active:scale-95 relative z-10 cursor-pointer"
          aria-label="Call us"
        >
          {/* React Icon */}
